...
const ReciladorPrincipal = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.reciladorprincipal}>
      <View style={styles.reciladorprincipalChild} />
      <Text style={[styles.sejaBemVindo, styles.sair1Typo]}>
        Seja bem vindo, Reciclador.
      </Text>
      <Pressable
        style={[styles.buton, styles.butonFlexBox]}
        onPress={() => navigation.navigate("ReciladorGerador")}
      >
        <Text style={[styles.geradores, styles.resduosTypo]}>Geradores</Text>
      </Pressable>
      <Pressable
        style={[styles.buton1, styles.butonFlexBox]}
        onPress={() => navigation.navigate("Residuos")}
      >
...
export default ReciladorPrincipal;
